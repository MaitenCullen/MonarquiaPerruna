  ...
  return (
    ...
    <section className="contacto__cards__sectionContainer">
        <div className="contacto__cards__container">
            ...
            <CardContacto img={iconoMail} tituloDeCard="Whatsapp" informacionDeCard="+54 911 2304-1275 Si tienes alguna consulta, escríbenos y te responderemos a la brevedad posible." />
            <CardContacto img={iconoMail} tituloDeCard="Mercado Shop" informacionDeCard="Monarquía perruna Revisa nuestros productos y dale a tu mascota la seguridad y comodidad que necesita."/>
        </div>
    </section>
    </>
)
