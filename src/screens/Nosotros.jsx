  ...
  return (
    <div className='sectionNosotros'> 
      <div className='divBanner1 w-full '>
        <h3  className='text-black'>Nosotros</h3>
      </div>
        <div  className='flex items-center justify-center flex-col py-9'>
          <div className='text-center'>
            ...
            <h4  className='text-black'>Somos Monarquía Perruna</h4>
          </div>
        ...
        <div className='containBanner2'>
          <div className='divBanner2 h-full'>
            ...
            <h4 className='text-black'>Nuestra visión</h4>
      ...
      <div className='flex justify-center flex-col py-9' >
        <div className='text-center'>
          ...
          <h4 className='text-black'>Nuestra misión</h4>
        </div>
        <div className='divCardDogId'>
          <div className='divDogID'>
            <div className="textNosotros">
              <p className='text-black'>Proporcionar productos para mascotas que sean funcionales, cómodos, seguros y con estilo, que mejoren su calidad de vida y la de sus dueños o dueñas.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className='flex items-end justify-center'>
            ...
            <div  className='APPdogID'>
              <div className='divAPPInfo '>
                <div className="divTextAPP">
                  <h4 className='text-black'>COMPROMISO</h4>
                  <p className='text-black'>
          ...
          <div className='divAPPNos'>
            <div  className='APPdogID'>
              <div className='divAPPInfo '>
                <div className="divTextAPP">
                  <h4 className='text-black'>INNOVACIÓN</h4>
                  <p className='text-black'>
          ...
          <div className='divAPPNos'>
            <div  className='APPdogID'>
              <div className='divAPPInfo '>
                <div className="divTextAPP">
                  <h4 className='text-black'>ALEGRÍA</h4>
                  <p className='text-black'>
          ...
          <div className='divAPPNos'>
            <div  className='APPdogID'>
              <div className='divAPPInfo '>
                <div className="divTextAPP">
                  <h4 className='text-black'>CALIDEZ</h4>
                  <p className='text-black'>
