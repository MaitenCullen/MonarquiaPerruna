         ...
         <div className='divAPP'>
            ...
            <img src={salud} className='imgAPP'/>
              <div className='divAPPInfo '>
                <div className="divTextAPP">
                    <h4 className='sm:text-base text-sm text-black'>HISTORIA MÉDICA</h4>
          ...
          <div className='divAPP'>
            ...
            <img src={ok} className='imgAPP'/>
              <div className='divAPPInfo '>
                <div className="divTextAPP">
                    <h4 className='sm:text-base text-sm text-black'>FÁCIL DE USAR</h4>
                    <p className='text-black'>
          ...
          <div className='divAPP'>
            ...
            <img src={salud} className='imgAPP'/>
              <div className='divAPPInfo '>
                <div className="divTextAPP">
                    <h4 className='sm:text-base text-sm text-black'>FÁCIL ACCESO</h4>
                    <p className='text-black'>
          ...
          <div className='divAPP'>
            ...
            <img src={circulo} className='imgAPP'/>
              <div className='divAPPInfo '>
                <div className="divTextAPP">
                    <h4 className='sm:text-base text-sm text-black'>DATOS ACTUALIZABLES</h4>
                    <p className='text-black'>
