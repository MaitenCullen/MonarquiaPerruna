...
const FortalezasContainer = () => {
    return (
        ...
        <div class="index__aboutUs__grid">
            ...
            <div className="index__ProductosDeCalidad__container">
            ...
            <div className="index__seguridadEnElProceso__container">
            ...
            <div className="index__AtencionPersonalizada__container">
            ...
            <div className="index__envios__container">
